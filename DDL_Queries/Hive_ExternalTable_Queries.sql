...
LOAD DATA INPATH '/user/airroute/airlines.dat' 
OVERWRITE INTO TABLE AIRLINES;



CREATE EXTERNAL TABLE IF NOT EXISTS PARTITIONED_AIRLINES ( 
	airline_id STRING,
	airline_name STRING,
	alias STRING, 
	iata_code STRING,
...
LOCATION '/user/airroute/tables/partitioned_airline';
...
LOCATION '/user/airroute/tables/airportsOrc';

LOAD DATA INPATH '/user/airroute/airports.dat' 
...
STORED AS SEQUENCEFILE
LOCATION '/user/airroute/tables/partitioned_airports';
...
LOAD DATA INPATH '/user/airroute/Air_Traffic_Cargo_Statistics.csv' 
OVERWRITE INTO TABLE CARGO_STATISTICS;
...
INSERT OVERWRITE TABLE PARTITIONED_CARGO_STATISTICS 
